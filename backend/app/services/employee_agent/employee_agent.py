...
class EmployeePerformanceAgent:
    def __init__(self):
        self.performance_file = r"C:\Users\Playdata\Desktop\SKN12-FINAL-1TEAM\data\Docs\DATABASE\총정리\내부규정\좋은제약_실적자료_최수아.xlsx"
        self.target_file = r"C:\Users\Playdata\Desktop\SKN12-FINAL-1TEAM\data\Docs\DATABASE\총정리\내부규정\좋은제약_지점별_목표.xlsx"
