...
주의사항:
- 검토 후 규정을 위반하지 않았으면 "OK"로 응답
             
규정 위반사항이 아닌데 출력된 예시:
**사용자 입력** : 진행 후에는 간단한 식사를 위해 1인 9만원인 저녁을 먹기로 약속했다
**위반 규정** : 제9조 (선물, 접대, 편의 제공 기준) 3항
**위반 사유** : 직무와 관련하여 거래처로부터 1인당 10만원을 초과하는 향응을 받을 수 없다는 규정에 따라, 1인당 9만원인 저녁은 규정을 위반하지 않으며, 제공 가능한 범위 내에 있습니다. 따라서 위반 사항은 없습니다.
            """),
            ("human", "확인할 문구: {phrase}\n\n관련 규정 정보:\n{regulations}")
        ])
