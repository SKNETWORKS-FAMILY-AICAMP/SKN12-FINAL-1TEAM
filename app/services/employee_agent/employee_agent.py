    ...
    def _analyze_query_node(self, state: AnalysisState) -> AnalysisState:
        ...
        try:
            ...
            if not query_analysis:
                state["error"] = "쿼리 분석에 실패했습니다. 예시: '홍길동의 2023년 1월부터 2023년 6월까지 실적 분석해줘'"
                return state
            ...
            if not employee_name:
                state["error"] = "직원명을 찾을 수 없습니다. 예시: '홍길동의 2023년 1월부터 2023년 6월까지 실적 분석해줘'"
                return state
            
            if not start_period or not end_period or start_period == "None" or end_period == "None":
                state["error"] = "분석 기간을 찾을 수 없습니다. 예시: '홍길동의 2023년 1월부터 2023년 6월까지 실적 분석해줘'"
                return state
